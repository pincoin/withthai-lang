# Generated by Django 2.0.7 on 2018-07-18 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_entry', to='voca.Entry', verbose_name='compound word')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('part', models.IntegerField(choices=[(0, 'noun'), (1, 'pronoun'), (2, 'verb'), (3, 'modifier'), (4, 'preposition'), (5, 'conjunction'), (6, 'interjection'), (7, 'classifier')], db_index=True, default=0, verbose_name='part of speech')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voca.Entry', verbose_name='entry')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.IntegerField(verbose_name='position')),
                ('chapter', models.IntegerField(verbose_name='chapter')),
                ('words', models.ManyToManyField(blank=True, through='voca.EntryTextbookCompound', to='voca.Entry')),
            ],
            options={
